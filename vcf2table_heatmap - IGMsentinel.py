...
tmp_phased_vcf.sort_values(by = ['3-44819982-A-G', '3-44727463-A-G'], axis = 1, ascending = False, inplace=True)
...
fig.savefig('internalsentinelSNP_QV_longIPFlist_dash.pdf', dpi=200)
